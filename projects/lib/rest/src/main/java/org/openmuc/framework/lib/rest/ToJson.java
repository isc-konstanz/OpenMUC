...
package org.openmuc.framework.lib.rest;

import static org.openmuc.framework.lib.rest.Const.VALUE_STRING;
...
import org.openmuc.framework.lib.rest.objects.RestChannelConfig;
import org.openmuc.framework.lib.rest.objects.RestChannelMapper;
import org.openmuc.framework.lib.rest.objects.RestChannelOptions;
import org.openmuc.framework.lib.rest.objects.RestChannelWrapper;
import org.openmuc.framework.lib.rest.objects.RestDevice;
import org.openmuc.framework.lib.rest.objects.RestDeviceConfig;
import org.openmuc.framework.lib.rest.objects.RestDeviceMapper;
import org.openmuc.framework.lib.rest.objects.RestDeviceOptions;
import org.openmuc.framework.lib.rest.objects.RestDeviceWrapper;
import org.openmuc.framework.lib.rest.objects.RestDriverConfig;
import org.openmuc.framework.lib.rest.objects.RestDriverInfo;
import org.openmuc.framework.lib.rest.objects.RestDriverMapper;
import org.openmuc.framework.lib.rest.objects.RestDriverSyntax;
