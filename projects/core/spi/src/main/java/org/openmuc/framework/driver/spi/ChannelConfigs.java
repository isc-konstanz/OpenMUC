...
public class ChannelConfigs extends Configurable implements ChannelRecordContainer, ChannelValueContainer {
    ...
    protected ChannelConfigs(ChannelContainer container) throws ArgumentSyntaxException {
	...
	public ChannelRecordContainer copy() {
		try {
			return new ChannelConfigs(container);
