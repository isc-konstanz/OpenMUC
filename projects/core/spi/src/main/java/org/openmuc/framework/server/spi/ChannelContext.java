...
public abstract class ChannelContext extends Configurable {
    ...
    void doCreate(ServerContext context) throws ArgumentSyntaxException {
    	this.context = context;
        this.onCreate(context);
        this.onCreate();
    }

    protected void onCreate(ServerContext context) throws ArgumentSyntaxException {
    ...
    public ServerContext getDevice() {
    	return context;
    }
