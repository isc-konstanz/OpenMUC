...
public class OptionSelection extends LinkedHashMap<Value, String>{
    ...
    OptionSelection(ValueType type) {
        super();
        this.type = type;
    }

    OptionSelection(ValueType type, boolean validate) {
        this(type);
        this.validate = validate;
    }

    OptionSelection(ValueType type, String selectionStr) throws ArgumentSyntaxException {
        this(type);
    ...
    void enableValidation(boolean enable) {
