var channel = 
{
    ...
    'update':function(ctrlid, nodeid, id, desc, configs)
    {
        var result = {};
        $.ajax({ url: path+"muc/channel/update.json", data: "ctrlid="+ctrlid+"&nodeid="+nodeid+"&id="+id+"&desc="+desc+"&configs="+JSON.stringify(configs), async: false, success: function(data) {result = data;} });
        return result;
    },
