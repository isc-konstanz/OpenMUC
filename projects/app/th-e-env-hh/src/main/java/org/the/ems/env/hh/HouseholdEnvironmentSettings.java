...
public class HouseholdEnvironmentSettings extends GenericSettings {
    ...
    public HouseholdEnvironmentSettings() {
        ...
        properties.put(INTERVAL, new ServiceProperty(
                INTERVAL, "Interval of the emulation control in seconds", String.valueOf(INTERVAL_DEFAULT), false)
        );
        ...
        properties.put(VALVE_PULSE_HEX_ENERGY, new ServiceProperty(
                VALVE_PULSE_HEX_ENERGY, "Thermal energy dissipation of the heat exchange of the PWM valve", "hh_flow_valve_energy", true)
        );
        ...
        properties.put(VALVE_THREE_WAY_HEX_TEMP_IN, new ServiceProperty(
                VALVE_THREE_WAY_HEX_TEMP_IN, "Temperature of the heat exchange inlet of the three-way valve valve", "hh_flow_valve_in_temp", true)
        );
