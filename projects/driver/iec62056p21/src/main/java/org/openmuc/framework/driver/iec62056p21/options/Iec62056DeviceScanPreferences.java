...
public class Iec62056DeviceScanPreferences extends Iec62056DevicePreferences {

    public Iec62056DeviceScanPreferences(Preferences settings) {
        super(null, settings);
    }

    public String getSerialPort() {
        
        if (settings.contains(PORT_KEY)) {
