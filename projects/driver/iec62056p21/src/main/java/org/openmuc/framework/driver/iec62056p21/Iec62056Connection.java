...
import org.openmuc.framework.driver.iec62056p21.serial.SerialConnection;
...
public class Iec62056Connection {
     ...
     */
    public List<Iec62056DataSet> read(Iec62056DevicePreferences settings, Set<String> ids) 
            throws IOException, TimeoutException {
        
        if (serial.isClosed()) {
            throw new IOException("Serial port connection is not open.");
        }
        List<Iec62056DataSet> dataSets = new ArrayList<Iec62056DataSet>();
        ...
        dataSets.add(new Iec62056DataSet(
     ...
     *             from the meter within the timeout span.
     */
    public List<Iec62056DataSet> read(Iec62056DevicePreferences settings) 
            throws IOException, TimeoutException {
        
        return read(settings, null);
    }

    private byte[] initiateWithHandshake(Iec62056DevicePreferences settings) throws IOException, TimeoutException {
    ...
    private byte[] initiateWithoutHandshake(Iec62056DevicePreferences settings) throws IOException, TimeoutException {
    ...
    private Iec62056DataSet requestDataSet(String identifier) throws IOException, TimeoutException {
    ...
    private List<Iec62056DataSet> parseDataSets(byte[] buffer) throws IOException {
    ...
    private Iec62056DataSet parseDataSet(byte[] buffer) throws IOException {
        int index = 0;
        ...
        return new Iec62056DataSet(id, value, unit);
    }
