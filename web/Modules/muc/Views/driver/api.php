...
<table class="table">
	...
	<tr><td><?php echo _('List available drivers'); ?></td><td><a href="<?php echo $path; ?>muc/driver/available.json?ctrlid=1"><?php echo $path; ?>muc/driver/available.json?ctrlid=1</a></td></tr>
